		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Proyecto inicial vacio",
									"targetURL": "#esjcmupesapui5projectjc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esjcmupesapui5projectjc-display": {
								"semanticObject": "esjcmupesapui5projectjc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=es.jcmupe.sapui5.projectjc",
									"url": sap.ui.require.toUrl("es/jcmupe/sapui5/projectjc")
								}
							}
						}
					}
